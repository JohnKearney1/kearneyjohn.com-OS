...
const CREDITS = [
    ...
    },
    {
        ...
        rows: [
            ...
            ['Future Cut', 'Co-Production'],
            ['Stuart Hawkes', 'Mastering Engineer'],
            ['Jonny Breakwell', 'Mixing Engineer'],
            ['Iviola Babalc', 'Auxiliary Percussion'],
            ['Darren Lewis', 'Auxillary Instrumentation']
        ],
    },
];
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        <Window
            ...
            bottomLeftText={'© Copyright 2022 John Kearney'}
        >
            <div
            ...
            >
                ...
                <p>John Kearney (p.k.a "kearneyonline")</p>
                <br />
                <br />
                <br />
